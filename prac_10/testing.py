...
assert return_sentence("hello") == "Hello."
assert return_sentence("It is an ex parrot.") == "It is an ex parrot."
assert return_sentence("i am eating a late lunch right now!") == "I am eating a late lunch right now!."
